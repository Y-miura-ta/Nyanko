...
def main():
    ...
    drawRobotFromXYZ(
        [-69.76653823016048, 0 ,-159.37150547517558],
        [9.794144495510615, 0, -130.65728494419318],
        [-33.2255412621588, 0, -109.44080704704247],
        [-33.09251919743277, 0, -109.95119194696883]
    )
